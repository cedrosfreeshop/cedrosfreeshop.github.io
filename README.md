...
**REALES/PESOS FRAME:**
  ...
  - GIVE A SHORT VIDEO THAT SUMMARIZE THE SELL OF THE DAY, AND COMPARE IT WITH THE SELL OF THIS DAY FROM THE PREVIOUS YEARS, AND WITH THE DAILY, MONTHLY, AND THIS DAY AVERAGE WITH AN OPTION TO EXPORT THE SUMMARY FOR THE DAY.
  ...
  - A GRAPH THAT SHOW THIS YEAR MONTH SELL CHANGES AND THE PEAKS.
  - A GRAPH THAT SHOW ALL YEAR MONTHLY SELL WITH DIFFERENT COLOR TO COMPARE IT.
  ...
  - AN OPTION TO SHOW ALL THE BILLS ACCORDING TO THE DAY/WEEK/MONTH.
  - AN OPTION TO SHOW ALL HOLIDAY OF THE CURRENT MONTH.
...
- PROPORCIONAR UN VÍDEO BREVE QUE RESUMA LAS VENTAS DEL DÍA Y COMPARARLAS CON LAS VENTAS DE ESTE DÍA DE LOS AÑOS ANTERIORES Y CON EL PROMEDIO DIARIO, MENSUAL Y DE ESTE DÍA CON UNA OPCIÓN PARA EXPORTAR EL RESUMEN DEL DÍA.
...
- UN GRÁFICO QUE MUESTRA LOS CAMBIOS EN LAS VENTAS DEL MES DE ESTE AÑO Y LOS PICOS.
- UN GRÁFICO QUE MUESTRA TODAS LAS VENTAS MENSUALES DEL AÑO CON DIFERENTES COLORES PARA COMPARARLAS.
...
- UNA OPCIÓN PARA MOSTRAR TODAS LAS FACTURAS SEGÚN EL DÍA/SEMANA/MES.
- UNA OPCIÓN PARA MOSTRAR TODOS LOS DÍAS FESTIVOS DEL MES ACTUAL.
...
- FAÇA UM VÍDEO CURTO QUE RESUMA A VENDA DO DIA, E COMPARE COM A VENDA DESTE DIA DOS ANOS ANTERIORES, E COM A MÉDIA DIÁRIA, MENSAL E DESTE DIA COM UMA OPÇÃO PARA EXPORTAR O RESUMO DO DIA.
...
- UM GRÁFICO QUE MOSTRA AS MUDANÇAS DE VENDA DESTE MÊS DO ANO E OS PICOS.
- UM GRÁFICO QUE MOSTRA TODAS AS VENDAS MENSAIS DO ANO COM CORES DIFERENTES PARA COMPARÁ-LAS.
...
- UMA OPÇÃO PARA MOSTRAR TODAS AS CONTAS DE ACORDO COM O DIA/SEMANA/MÊS.
- UMA OPÇÃO PARA MOSTRAR TODOS OS FERIADOS DO MÊS ATUAL.
...
- DONNEZ UNE COURTE VIDÉO QUI RÉSUME LA VENTE DU JOUR, ET COMPAREZ-LA AVEC LA VENTE DE CE JOUR DES ANNÉES PRÉCÉDENTES, ET AVEC LA MOYENNE QUOTIDIENNE, MENSUELLE ET DE CE JOUR AVEC UNE OPTION D'EXPORTATION DU RÉSUMÉ DU JOUR.
...
- UN GRAPHIQUE QUI MONTRE LES CHANGEMENTS DE VENTES DU MOIS DE CETTE ANNÉE ET LES PICS.
- UN GRAPHIQUE QUI MONTRE TOUTES LES VENTES MENSUELLE DE L'ANNÉE AVEC DIFFÉRENTES COULEURS POUR LES COMPARER.
...
- UNE OPTION POUR AFFICHER TOUTES LES FACTURES SELON LE JOUR/SEMAINE/MOIS.
- UNE OPTION POUR AFFICHER TOUS LES JOURS FÉRIÉS DU MOIS EN COURS.
