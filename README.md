...
**INTRO FRAME:**
 ...
 - IT HAS SETTING TO CONFIGURE THE APP.
 - IT HAS AN AUTO-CHECK FOR UPDATE, A BUTTON AT BOTTOM APPEARS WHEN THERE IS A NEW UPDATE.
 - AN OPTION TO DOWNGRADE FOR ANY PREVIOUS VERSION (TOOLTIP APPEAR WITH THE CHANGELOG FOR THE VERSION).
 ...
 - A SIGN UP FOR NEW USER (ONE PER PC).
 - OPTION TO FORGET YOUR PASSWORD.
...
**REALES/PESOS FRAME:**
  ...
  - OPTION TO SHOW THE INVOICES OF THE PAST DAYS ACC TO INVOICE NUMBER, QUANTITY SOLD, PRICE, PROFIT OR SELLER.
  ...
  - AN OPTION TO CHANGE THE DEFAULT INSIDE PASSWORD
...
**STOCK:**
  ...
  - REMOVE OLD SALE, IF A CLIENT CHANGE IT OR IT HAS PROBLEM.
  - STOCK OVERVIEW, THAT PRESENT THE TOTAL INVESTMENT WITH DETAILS.
  ...
  - SEARCH THE LOST OF CERTAIN MERCHANDISE ACC TO DATE(GIVEN DATE OR BETWEEN TWO DATES).
  ...
  - BROWSE THE UNSOLD ITEM BETWEEN TWO DATES.
  - BROWSE THE OUT-OF-STOCK ITEMS BETWEEN TWO DATES.
  ...
  - BROWSE THE REAL TIME STOCK WITH THE TODAY'S SALES.
  - ADD THE TOP 3 SELL BY QTY, PRICE AND PROFIT FOR THE DAILY SUMMARY.
  - ADD THE TOP 10 SELL BY QTY, PRICE AND PROFIT FOR THE MONTHLY/YEARLY SUMMARY.
...
**EMPLOYEES:**
  - SHOW THE STOCK ITEMS WITH PRICE.
  - ADD/EDIT/REMOVE EMPLOYEES WITH HIRING DATE, SALARY AND POSTION.
  - EDIT FREE WEEK DAYS/ABSCENSE/LICENSE TO EACH ONE.
  - PRESENT THE FREE DAYS AS TABLE MULTITABBED WITH ITS TOTAL DAYS.
  - PRESENT THE FREE DAYS AS CALENDAR WITH TOOLTIP AND LEGEND TO SHOW IT.
  - ADD THE WEEKLY SALARY, LICENSE AND YEARLY BONUS DATA.
  - PRESENT THE SALARY AS TABLE MULTITABBED.
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/empf5.png)
 ...
 - ## EXTRA:
  ...
  - A CALENDAR TO BROWSE ALL EVENTS.
  - SHORTKEYS DIALOG THAT CAN USE IT IN BILLS/AGGREGATES.
  - CLEAN CASH FOR THE APP.
