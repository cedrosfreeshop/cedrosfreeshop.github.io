...
- POSSUI UMA CONFIGURAÇÃO PARA CONFIGURAR O APLICATIVO.
- POSSUI VERIFICAÇÃO AUTOMÁTICA DE ATUALIZAÇÕES. UM BOTÃO APARECE NA PARTE INFERIOR QUANDO UMA NOVA ATUALIZAÇÃO ESTÁ DISPONÍVEL.
- UMA OPÇÃO PARA QUALQUER VERSÃO ANTERIOR (UMA DICAS DE FERRAMENTA APARECE COM O LOG DE ALTERAÇÕES DA VERSÃO).
...
- REGISTRO DE NOVO USUÁRIO (UM POR PC).
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/downgrade1.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/downgrade2.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/setting1.png)
...
- EXCLUIR A VENDA ANTERIOR CASO O CLIENTE A MODIFIQUE OU TENHA QUALQUER PROBLEMA.
- RESUMO DO ESTOQUE, MOSTRANDO O INVESTIMENTO TOTAL EM DETALHES.
...
- UMA OPÇÃO PARA ALTERAR A SENHA INTERNA PADRÃO
...
- DESEMPENHO DA MERCADORIA PARA VER O STATUS DAS VENDAS DE CADA MERCADORIA DISPONÍVEL.
- ANÁLISE DE VENDAS PARA NAVEGAR EM QUALQUER ANÁLISE DE MERCADORIAS ENTRE DUAS DATAS.
- RESUMO DO ITEM PARA NAVEGAR EM UM RESUMO DAS VENDAS DO ITEM SELECIONADO.
- ADMIN: ALTERE O NOME DA MERCADORIA, TOTAL, PREÇO, CATEGORIA.
- DESEMPENHO DA MERCADORIA PARA VISUALIZAR O STATUS DE VENDAS DE CADA ITEM DISPONÍVEL.
- ANÁLISE DE VENDAS PARA EXPLORAR A QUANTIDADE DE MERCADORIAS ENTRE DUAS DATAS.
- RESUMO DO ITEM PARA EXPLORAR O RESUMO DE VENDAS DO ITEM SELECIONADO.
...
- BUSCA POR PERDA DE DETERMINADOS BENS DE ACORDO COM A DATA (DATA INFORMADA OU ENTRE DUAS DATAS).
- NAVEGUE PELOS ITENS NÃO VENDIDOS ENTRE DUAS DATAS.
- NAVEGUE PELOS ITENS FORA DA LOJA ENTRE DUAS DATAS.
...
- NAVEGUE PELO ESTOQUE EM TEMPO REAL COM AS VENDAS DE HOJE.
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockana.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockadd.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockremove.png)
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stocktoppf.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/invoice1.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockold1.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockold2.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockold3.png)
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/stockout.png)
...
**FUNCIONÁRIOS:**
- EXIBIR ITENS EM ESTOQUE COM PREÇO.
- ADICIONE/EDITE/REMOVA FUNCIONÁRIOS COM DATA DE CONTRATAÇÃO, SALÁRIO E CARGO.
- EDITE OS DIAS DE FOLGA/AUSÊNCIA/LICENÇA DA SEMANA PARA CADA PESSOA.
- EXIBA OS DIAS DE FOLGA COMO UMA TABELA COM VÁRIAS ABAS E SEUS TOTAIS DIAS.
- EXIBA OS DIAS DE FOLGA COMO UM CALENDÁRIO COM INFORMAÇÕES ROTATIVAS E UMA LEGENDA.
- ADICIONE DADOS DE SALÁRIO SEMANAL, FÉRIAS E BÔNUS ANUAL.
- EXIBA O SALÁRIO COMO UMA TABELA COM VÁRIAS ABAS.
- ADICIONE AUTOMATICAMENTE AS VENDAS DE CADA UM NO FINAL DO DIA.
- MOSTRE AS VENDAS DE CADA FUNCIONÁRIO COMO TABELA.
- MOSTRE AS VENDAS DE TODOS OS FUNCIONÁRIOS E DO MÊS COMO GRÁFICO, COM O DIA SEMANAL LIVRE COMO PONTO VAZIO.
- MOSTRE A DIFERENÇA DE VENDAS DE TODOS OS FUNCIONÁRIOS COMO DIAGRAMA.
- MOSTRE O RESUMO DE CADA FUNCIONÁRIO COMO DIÁLOGO, COM DETALHES.
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/emp7.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/emp8.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/emp9.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/emps1.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/emps2.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/empf1.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/empf2.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/empf3.png)
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/empf4.png)
...
- UM CALENDÁRIO PARA NAVEGAR POR TODOS OS EVENTOS.
- CAIXA DE DIÁLOGO DE TECLAS DE ATALHO QUE PODE SER USADA EM CONTAS/AGREGADOS.
- DINHEIRO LIMPO PARA O APLICATIVO.
...
![alt text](https://github.com/cedrosfreeshop/cedrosfreeshop.github.io/blob/main/preview/invoice4.png)
